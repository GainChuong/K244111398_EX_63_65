...
function create_new_emp(){
    ...
    Colors=document.querySelector('input[name="color"]:checked').value
    
    emp={"Name": Name,"Email":Email,"Gender":Gender,"Birthday":Birthday,"Hobbies":Hobbies.join(", "),"Colors":Colors}
